...
import com.singhajit.sherlock.engine.app.crashlytics.crashes.adapter.CrashAdapter;
import com.singhajit.sherlock.engine.app.crashlytics.crashes.presenter.CrashListPresenter;
...
public class CrashListActivity extends BaseActivity implements CrashListActions {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    setTitle(R.string.crash_activity_name);
