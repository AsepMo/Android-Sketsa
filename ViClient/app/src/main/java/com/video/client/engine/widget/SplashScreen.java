package com.video.client.engine.widget;
...
import com.video.client.application.ApplicationInstallation;
...
public class SplashScreen extends RelativeLayout {
    ...
    protected void onFinishInflate() {
        ...
        mSplashFrame = inflater.inflate(R.layout.layout_splash_screen, this, false);
    ...
    public void createShortCut(Activity c) {
        ...
        Settings.setIsShortCut(mContext, true);
    }
