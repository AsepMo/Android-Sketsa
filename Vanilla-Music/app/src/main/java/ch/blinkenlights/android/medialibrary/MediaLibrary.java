...
public class MediaLibrary  {
	...
	public static MediaLibrary.Preferences getPreferences(Context context) {
		...
		if (prefs == null) {
			try {
                ...
                ObjectInputStream ois = new ObjectInputStream(context.openFileInput(PREFERENCES_FILE));
	...
	public static void setPreferences(Context context, MediaLibrary.Preferences prefs) {
		...
		try {
            ...
            ObjectOutputStream oos = new ObjectOutputStream(context.openFileOutput(PREFERENCES_FILE, 0));
